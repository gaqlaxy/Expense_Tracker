...
export default function SummaryCards({
  ...
  const totalThisWeek = calculateTotal(thisWeekExpenses);
  // const stats = [
  //   {
  //     title: "Income",
  //     value: `₹${totalIncome}`,
  ...
  //   },
  // ];
  const balance = totalIncome - totalThisMonth;
  const spendingPercent = totalIncome
    ? ((totalThisMonth / totalIncome) * 100).toFixed(1)
    : 0;

  const stats = [
    {
      title: "Income",
      value: `₹${totalIncome} (${spendingPercent}% spent)`,
      icon: <FiCalendar size={20} />,
      light: "from-white to-green-50 border-green-100",
      dark: "from-gray-800 to-green-900 border-green-800",
      iconBg: "bg-green-100 dark:bg-green-800",
    ...
    },
    {
      ...
      value: `₹${balance}`,
      icon: <FiTrendingUp size={20} />,
      light: "from-white to-teal-50 border-teal-100",
      dark: "from-gray-800 to-teal-900 border-teal-800",
      iconBg: "bg-teal-100 dark:bg-teal-800",
      iconText: "text-teal-600 dark:text-teal-300",
      valueText: "text-teal-600 dark:text-teal-300",
    },
    {
      title: "This Week",
      value: `₹${totalThisWeek}`,
      icon: <FiCalendar size={20} />,
      light: "from-white to-indigo-50 border-indigo-100",
      dark: "from-gray-800 to-indigo-900 border-indigo-800",
    ...
    {
      title: "Transactions",
      value: `${totalTransactions} (${thisWeekTransactions} this week)`,
      icon: <FiList size={20} />,
      light: "from-white to-pink-50 border-pink-100",
      dark: "from-gray-800 to-pink-900 border-pink-800",
      iconBg: "bg-pink-100 dark:bg-pink-800",
